...
消息ID：msg-1783103571336-3f49617385526
角色消息池：.coss/agent-pools/qa-engineer/inbox/msg-1783103571336-3f49617385526.json
...
1. Call coss_pool_read({ roleId: "qa-engineer", taskId: "task-1782409117099-e7cbf10023153" }) to read your own inbox.
2. Call coss_pool_claim({ roleId: "qa-engineer", messageId: "msg-1783103571336-3f49617385526" }) before processing this message.
...
步骤ID：step-subtask-1782409117100-911992ba45f02
目标角色：测试工程师 (qa-engineer)
步骤标题：验证核心流程
步骤说明：覆盖成功、失败、空状态和异常流程。
...
允许能力：test.plan, test.execute, browser.inspect, artifact.write_report
