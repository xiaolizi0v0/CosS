...
消息ID：msg-1783103571336-1dae4fac759b
角色消息池：.coss/agent-pools/backend-engineer/inbox/msg-1783103571336-1dae4fac759b.json
...
1. Call coss_pool_read({ roleId: "backend-engineer", taskId: "task-1782409117099-e7cbf10023153" }) to read your own inbox.
2. Call coss_pool_claim({ roleId: "backend-engineer", messageId: "msg-1783103571336-1dae4fac759b" }) before processing this message.
...
步骤ID：step-subtask-1782409117100-64180e1530fc5
目标角色：后端工程师 (backend-engineer)
步骤标题：确认接口和数据边界
步骤说明：检查或实现任务所需的后端能力。
...
允许能力：code.backend, api.implement, data.model, artifact.write_code
