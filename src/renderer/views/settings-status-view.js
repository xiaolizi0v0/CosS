(function exposeSettingsStatusView(global) {
  function createSettingsStatusRenderer({
    ...
    function renderModelSettingsSection() {
      ...
      const apiKeyPlaceholder = editingModel.apiKeyRequired ? t("model.apiKey.placeholder.required", "必填，填写后才可以切换到该模型") : t("model.apiKey.placeholder.optional", "可选，按模型服务要求填写");
