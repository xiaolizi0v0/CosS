...
const IPC_CHANNELS = Object.freeze({
  ...
  BLUEPRINT_COMMAND_RUN: "blueprint-command:run",
  BLUEPRINT_AGENT_RUN: "blueprint-agent:run",
  BLUEPRINT_BROWSER_RUN: "blueprint-browser:run",
  BLUEPRINT_MCP_RUN: "blueprint-mcp:run",
